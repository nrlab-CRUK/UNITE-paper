...
```bash
cd /scratchb/nrlab/wang04/lucid_download
/home/bioinformatics/software/java/java17/bin/java -jar /home/nrlab/tools/clarity-tools.jar -l SLX-10554 -l SLX-11856 -l SLX-12526 -l SLX-10967 -l SLX-12530

```

## Make TAP config file and run TAP
