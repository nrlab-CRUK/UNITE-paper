...
parser.add_argument("--x_file",
                    ...
                    # required=True,
                    type=str,
                    default='x_clean_n_isize_TF_0_0.01_.npy',
                    dest="x_file")
...
# get everything after "TF_" in the x_file, including 'TF_', excluding '.npy'
# this will be used to name the output file
TF_label = args.x_file[args.x_file.find('TF_'):]
TF_label = TF_label[:-4]
performance_csv = 'performance' + TF_label + '.debug.csv'
