...
ichorcna_tf_cutoff_lower_default <- c(0, 0.01, 0.03, 0.1, 0.2, 0)
ichorcna_tf_cutoff_upper_default <- c(0.01, 0.03, 0.1, 0.2, 1, 1)
...
#   mae_file = mae_file,
#   seed = seed_number_hyper,
#   final_test_hyper = final_test_hyper,
#   outdir = outdir,
...
para_df %>%
  furrr::future_pmap(
    ...
    final_test_hyper = final_test_hyper,
    outdir = outdir,
    .options = furrr_options(seed = seed_number_hyper)
  )
