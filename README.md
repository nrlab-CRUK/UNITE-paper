...
The meta data of each sample is in the `Table S12` in the manuscript. (Also see the meta_for_samples_to_upload.xlsx file in the repository for quick reference).  

The data (.tsv.gz) are derived from 0.1x bam (hg19) files, paired reads were merged into fragments using cfDNAPro (https://github.com/NRLAB-CRUK/cfDNAPro) developed by the lab (Wang et al, Genome Biology, 2025). 
